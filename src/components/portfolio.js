                    ...
                    <div class="col-md-8">
                        <div class="jumbotron jumbotron-fluid mt-5 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-2 one">
                                    I am Chandan. Computer Science Undergrad passionate to safeguard organizations through the use of my knowledge in cybersecurity. </p>
                            </div>
                        </div>
                        ...
                        <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                <h3 class="p-2">Contact Me: <a href="mailto:chandan@gmail.com">Email</a> <a href="LinkedInProfile">LinkedIn</a> +91 9505278929</h3>
                            </div>
                        </div>
                    </div>
                </div>
